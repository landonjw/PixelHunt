...
public class BaseHuntBoard {
     ...
     */
    public static PaginationList of(Map<BaseHunt, Instant> hunts){
        ...
        int numHunts = 0;
        for(BaseHunt hunt : hunts.keySet()){
            numHunts++;
     ...
     */
    private static Text getHuntDescription(BaseHunt hunt, Instant timeStarted){
     ...
     */
    private static Text getPokemonText(BaseHunt hunt){
     ...
     */
    private static Text getNatureText(BaseHunt hunt){
     ...
     */
    private static Text getRewardText(BaseHunt hunt){
     ...
     */
    private static Text getExpiryText(BaseHunt hunt, Instant timeStarted){
